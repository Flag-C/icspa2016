...
make_group(group1_b,
           ...
           and_i2rm_b, sub_i2rm_b, xor_r2rm_b, cmp_i2rm_b)
...
helper_fun opcode_table [256] = {
	...
	/* 0x74 */	jz_i_b, jnz_i_b, jbe_i_b, ja_i_b,
...
helper_fun _2byte_opcode_table [256] = {
	...
	/* 0x20 */	mov_crx2r, mov_r2crx, inv, inv,
	...
	/* 0x44 */	cmovz_rm2r_v, cmovnz_rm2r_v, cmovbe_rm2r_v, cmova_rm2r_v,
	/* 0x48 */	cmovs_rm2r_v, cmovns_rm2r_v, cmovp_rm2r_b, cmovnp_rm2r_v,
	...
	/* 0x88 */	js_i_v, jns_i_v, jp_i_b, jnp_i_v,
	/* 0x8c */	jl_i_v, jge_i_v, jle_i_v, jg_i_v,
	/* 0x90 */	seto_rm_b, setno_rm_b, setb_rm_b, setae_rm_b,
	/* 0x94 */	setz_rm_b, setnz_rm_b, setbe_rm_b, seta_rm_b,
	...
	/* 0xb4 */	inv, inv, movzxb_v, movzxw_l,
	/* 0xb8 */	inv, inv, inv, inv,
	/* 0xbc */	inv, inv, movsxb_v, movsxw_l,
